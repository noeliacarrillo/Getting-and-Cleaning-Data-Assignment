This code book EXPLAINS the resulting data fields in "tidy_dataset_assignment.txt"
...
# Measurements: t = temperature, f = frecuenc, Acc = Accelerometer, Gyro = Gyroscope
